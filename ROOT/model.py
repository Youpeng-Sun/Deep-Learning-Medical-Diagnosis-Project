...
class ResNet18(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        img_model = models.resnet18(weights=ResNet18_Weights.DEFAULT if cfg.pretrained else None)
        self.cfg = cfg
...
class PCAM_Model(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if self.cfg.backbone == 'densenet121':
            ...
            self.img_model = models.resnet18(weights=ResNet18_Weights.DEFAULT if cfg.pretrained else None)
            self.num_ftrs = 512
